package com.projectManagement.userProjectController;
...
public class UserProjectController {
	...
	public String allProjectList(Model model ,Authentication authentication) {
		...
		try {
			...
			return listByPageProject(model, authentication, 1);
	...
	@RequestMapping("/getProject/page/{pageNumber}")
	public String listByPageProject(Model model, Authentication authentication, @PathVariable("pageNumber") int currentPage) {
		...
		try {
			...
			Page<Project> page = projectServiceInterface.listAll(currentPage);
