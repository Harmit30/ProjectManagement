...
public class Task {
	...
	public String toString() {
		return "Task [task_id=" + task_id + ", task_title=" + task_title + ", atask_desc=" + atask_desc
				+ ", start_Date=" + start_Date + ", end_Date=" + end_Date + ", task_Status=" + task_Status
				+ ", task_user_id=" + task_user_id + ", task_project_id=" + task_project_id + "]";
	}
